...
class change_User_password(Toplevel):  # 这里要用Toplevel不能用Tk因为tkinter只支持一个主窗体存在.要想再跳出一个窗体必须选Toplevel
    ...
    def Setup_UI(self):
        ...
        self.entry_login_user = ttk.Entry(self.pane, state=DISABLED, textvariable=self.var_loginuser,
                                          font=("微软眼黑", 14, "bold"), width=16)
        ...
        self.entry_old_password = ttk.Entry(self.pane, show="*", textvariable=self.var_old_password,
                                            font=("微软眼黑", 14, "bold"), width=16)
        ...
        self.entry_new_password = ttk.Entry(self.pane, show="*", textvariable=self.var_new_password,
                                            font=("微软眼黑", 14, "bold"), width=16)
        ...
        self.entry_reinput_password = ttk.Entry(self.pane, show="*", textvariable=self.var_reinput_password,
                                                font=("微软眼黑", 14, "bold"), width=16)
