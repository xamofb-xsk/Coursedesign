...
class Detail_Windows(Toplevel):  # 这里要用Toplevel不能用Tk因为tkinter只支持一个主窗体存在.要想再跳出一个窗体必须选Toplevel
    def __init__(self, action_flag: int, current_stu: list, all_stu_list: list):
        ...
        # self.iconbitmap(R"C:\Usears\Administrator\python_图库\china.ico")  # 加载.ico文件
        self["bg"] = "RoyalBlue"
    ...
    def Setup_UI(self):
        ...
        self.login_img = PhotoImage(
            file=R"C:\Users\Administrator\PycharmProjects\untitled1\wangzhexiagu\GUI_student_system\photo\beijingtu.png")
        ...
        self.entry_homeaddress = ttk.Entry(self.pane, textvariable=self.var_homeaddress, font=("微软眼黑", 12, "bold"),
                                           width=59)
        ...
        self.entry_admission_time = ttk.Entry(self.pane, textvariable=self.var_admission_time,
                                              font=("微软眼黑", 12, "bold"), width=18)
        ...
        self.entry_professional = ttk.Entry(self.pane, textvariable=self.var_professional, font=("微软眼黑", 12, "bold"),
                                            width=15)
        ...
        self.entry_emergency_contact = ttk.Entry(self.pane, textvariable=self.var_emergency_contact,
                                                 font=("微软眼黑", 12, "bold"), width=15)
        ...
        self.entry_emergency_mobile = ttk.Entry(self.pane, textvariable=self.var_emergency_mobile,
                                                font=("微软眼黑", 12, "bold"), width=20)
        self.entry_emergency_mobile.place(x=470, y=270)
    ...
    def load_windows_flag(self):
        ...
        if self.flag == 1:
            ...
            self.var_titel.set("== 添加学生信息 ==")
        elif self.flag == 3:
            self.var_titel.set("== 修改学生信息 ==")
            # 先填充数据
            self.load_stu_detail()
            # 控制学号不允许修改
            self.entry_number["state"] = DISABLED
